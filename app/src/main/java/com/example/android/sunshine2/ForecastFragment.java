...
public  class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id== R.id.action_refresh) {
            ...
            fetchWeatherTask.execute("11600");
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, List<Forecast>> {
        ...
        private List<Forecast> getWeatherDataFromJson(String forecastJsonStr, int numDays) throws JSONException {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                newForecast.setFecha(day);
                newForecast.setMaxTemp(high);
                newForecast.setMinTemp(low);
                resultForecast.add(newForecast);
            }
